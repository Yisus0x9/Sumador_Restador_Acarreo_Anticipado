...
HD_PWD='D:/Arqui/sumadorCAA/sumadorCAA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sumRes4BCA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sumRes4BCA.tcl -notrace
